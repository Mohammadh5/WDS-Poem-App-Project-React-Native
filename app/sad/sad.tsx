        ...
        >
            <View style={styles.overlay}>
                ...
                <View style={styles.buttonContainer}>
                                                  <TouchableOpacity style={styles.moodButton} onPress={() => router.push("/sad/poems")}>
                                                    <Text style={styles.buttonText}>Poems</Text>
                                                  </TouchableOpacity>
                                
                                                  <TouchableOpacity style={styles.moodButton} onPress={() => router.push("/sad/music")}>
                                ...
                                const styles = StyleSheet.create({
                                  ...
                                  title: { color: "rgba(49, 160, 191, 1)" , fontSize: 70, fontWeight: "bold", textAlign: "center", marginBottom: 20, fontFamily: 'Courier' },
